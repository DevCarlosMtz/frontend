...
/**
 * Obtiene un item dependiendo del usuario
 * @param {Object} objectShowHasUsuario
 */
    async showHasUsuario(objectShowHasUsuario) {
      return await $axios.get(`${URL}/showHasUsuario`, {
        params: objectShowHasUsuario,
      })
    },
