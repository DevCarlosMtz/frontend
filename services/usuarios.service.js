...
export default ($axios) => {
  return {
   ...
   async index(objectIndex) {
    ...
    /**
     * Verifica un el correo de un usuario
     *
     * @param {Object} objectUpdate
     * @returns {Promise}
     */
    async verificar(objectVerificar) {
      objectVerificar = {
        _method: 'PUT',
        ...objectVerificar,
      }

      let formData = objectToFormData(objectVerificar)
      return await $axios.post(`${URL}/verificar`, formData)
    },
